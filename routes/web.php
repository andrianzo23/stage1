...
Route::group(['middleware' => ['installed', 'checkBackend', 'auth'], 'prefix' => 'dashboard'], function () {
    ...
    Route::post('course/store', 'Course\CourseController@store')->name('course.store');
    ...
    Route::post('course/update', 'Course\CourseController@update')->name('course.update');
    ...
    Route::post('class/store', 'Course\ClassController@store')->name('classes.store');
    Route::get('class/edit/{id}', 'Course\ClassController@edit')->name('classes.edit');
    Route::post('class/update', 'Course\ClassController@update')->name('classes.update');
    ...
    Route::post('class/content/store', 'Course\ContentController@store')->name('classes.contents.store');
    ...
    Route::post('course/slug/check', 'Course\CourseController@check')->name('slug.check');
    ...
    Route::post('/profile/update', 'Instructor\InstructorController@update')->name('instructors.update');
    Route::post('/users/banned', 'Instructor\InstructorController@banned')->name('users.banned');
    ...
    Route::post('message/send', 'Module\MessageController@send')->name('messages.replay');
    ...
    Route::post('comments/replay', 'Module\MessageController@commentReplay')->name('comments.replay');

    //account setup
    Route::get('account/setup', 'Module\PaymentController@accountSetup')->name('account.create');
    Route::post('account/update', 'Module\PaymentController@accountUpdate')->name('account.update');
    ...
    Route::post('user/store', 'UserManager\UserController@store')->name('users.store');
    Route::get('user/edit/{id}', 'UserManager\UserController@edit')->name('users.edit');
    Route::post('user/update', 'UserManager\UserController@update')->name('users.update');
    ...
    Route::post('media/index', 'MediaManagerController@main')->name('media.main');
    Route::get('media/manager/create', 'MediaManagerController@create')->name('media.create');
    Route::post('media/manager/store', 'MediaManagerController@store')->name('media.store');
    ...
    Route::post('media/manager/update/{id}', 'MediaManagerController@update')->name('media.update');
    Route::post('media/manager/slide', 'MediaManagerController@slide')->name('media.slide');
    Route::post('media/manager/filter/{type}', 'MediaManagerController@filter')->name('media.filter');
    ...
    Route::post('smtp/store', 'Setting\SettingController@smtpStore')->name('smtp.store');

    //site setting
    Route::get('site/setting', 'Setting\SettingController@siteSetting')->name('site.setting');
    Route::post('site/setting/update', 'Setting\SettingController@siteSettingUpdate')->name('site.update');

    //app site setting
    Route::get('app/setting', 'Setting\SettingController@appSetting')->name('app.setting');
    Route::post('app/setting/update', 'Setting\SettingController@appSettingUpdate')->name('app.update');
    ...
    Route::post('currency/store', 'Setting\CurrencyController@store')->name('currencies.store');
    ...
    Route::post('currency/update', 'Setting\CurrencyController@update')->name('currencies.update');
    Route::post('currency/default', 'Setting\CurrencyController@default')->name('currencies.default');
    ...
    Route::post('currency/change', 'Setting\CurrencyController@change')->name('currencies.change');
    ...
    Route::post('ticket/store', 'Module\SupportTicketController@store')->name('tickets.store');
    Route::get('ticket/show/{id}', 'Module\SupportTicketController@show')->name('tickets.show');
    Route::post('ticket/replay', 'Module\SupportTicketController@replay')->name('tickets.replay');
    ...
    Route::post('payments/store', 'Module\PaymentController@store')->name('payments.store');
    ...
    Route::post('category/store', 'Module\CategoryController@store')->name('categories.store');
    Route::get('category/edit/{id}', 'Module\CategoryController@edit')->name('categories.edit');
    Route::post('category/update', 'Module\CategoryController@update')->name('categories.update');
    ...
    Route::post('packages/store', 'Module\PackageController@store')->name('packages.store');
    Route::post('packages/update', 'Module\PackageController@update')->name('packages.update');
    ...
    Route::post('slider/store', 'Module\SliderController@store')->name('sliders.store');
    ...
    Route::post('slider/update', 'Module\SliderController@update')->name('sliders.update');
    ...
    Route::post('pages/store', 'Module\PageController@store')->name('pages.store');
    Route::get('pages/edit/{id}', 'Module\PageController@edit')->name('pages.edit');
    Route::post('pages/update', 'Module\PageController@update')->name('pages.update');
    ...
    Route::post('pages/content/store', 'Module\PageController@contentStore')->name('pages.content.store');
    ...
    Route::post('pages/content/update', 'Module\PageController@contentUpdate')->name('pages.content.update');
    ...
    Route::post('theme/store', 'Module\ThemesController@store')->name('themes.store');
