                    ...
                    <div class="col-lg-9">
                        @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Instructor")
                            <textarea required
                                      ...
                                      rows="5">{!!  \Mews\Purifier\Facades\Purifier::clean($each_course->short_description)!!}</textarea>
                            @error('short_description') <span class="invalid-feedback"
                                                              role="alert"> <strong>{{ $message }}</strong> </span> @enderror
                        @else
                        {!! \Mews\Purifier\Facades\Purifier::clean($each_course->short_description) !!}
                        @endif
                    ...
                    <div class="col-lg-9">
                        @if(\Illuminate\Support\Facades\Auth::user()->user_type == "Instructor")
                            <textarea required
                                      ...
                                      rows="5">{!! \Mews\Purifier\Facades\Purifier::clean($each_course->big_description) !!}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <textarea id="val-meta_description" name="meta_description"
                                  ...
                                  data-role="tagsinput" {{ Auth::user()->user_type != 'Admin' ? '' : 'readonly' }}> {!! \Mews\Purifier\Facades\Purifier::clean($each_course->meta_description)!!}</textarea>
