        ...
        <div id="Video" class="docs">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    ...
                    @if (MediaActive())
                     {{-- media --}}
                    <a href="javascript:void()" onclick="openNav('{{ route('media.slide') }}', 'file')" class="btn btn-primary media-btn d-none mt-2 p-2">Upload From Media <i class="fa fa-cloud-upload ml-2" aria-hidden="true"></i> </a>
                    @endif
    ...
    <div class="">
        <div class="form-group row is-invalid">
            ...
            <div class="col-lg-9">
                ...
                @if (MediaActive())
                     {{-- media --}}
                    <a href="javascript:void()" onclick="openNav('{{ route('media.slide') }}', 'source_code')" class="btn btn-primary media-btn mt-2 p-2">Upload From Media <i class="fa fa-cloud-upload ml-2" aria-hidden="true"></i> </a>
                @endif
