    ...
    <div class="card-body mx-3">
        <form action="{{ route('course.store') }}" method="post"  enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <textarea required="required" class="form-control summernote @error('short_description') is-invalid @enderror" name="short_description" rows="5" aria-required="true">{!! \Mews\Purifier\Facades\Purifier::clean(old('short_description')) !!}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <textarea id="val-meta_description" name="meta_description" class="form-control @error('meta_description') is-invalid @enderror" data-role="tagsinput"> {!! \Mews\Purifier\Facades\Purifier::clean(old('meta_description')) !!}</textarea>
