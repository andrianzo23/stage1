...
<div class="card-body">
    @if($payment->status != "Confirm" )
        <form action="{{route('affiliate.payments.status',$payment->id)}}" method="get" enctype="multipart/form-data">
            @csrf
            @endif
            ...
            <div class="form-group">
                ...
                <textarea  class="form-control" readonly>{!! \Mews\Purifier\Facades\Purifier::clean($payment->description) !!}</textarea>
            </div>
