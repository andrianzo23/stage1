                    ...
                    <div class="widget has-shadow">
                        <div class="widget-body">
                            ...
                            <div class="text-center">
                                ...
                                <img src="{{ filePath($each_user->relationBetweenPackage->image) }}" class="img-fluid rounded-sm package-img">
                                <div class="em-separator separator-dashed"></div>
                                Price: <span class="text-primary">{{formatPrice($each_user->relationBetweenPackage->price)}}</span>
                                <div class="em-separator separator-dashed"></div>
                                @translate(Commission): <span class="text-primary">{{formatPrice($each_user->relationBetweenPackage->commission)}}</span>
                            </div>
                            ...
                            <div class="tab-pane fade show active" id="information" role="tabpanel"
                                ...
                                <div class="widget-body">
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control"
                                                      name="address">{!! \Mews\Purifier\Facades\Purifier::clean($each_user->address) !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row d-flex align-items-center mb-5">
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea class="form-control"
                                                      name="about">{!! \Mews\Purifier\Facades\Purifier::clean($each_user->about) !!}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row d-flex align-items-center mb-5">

                                        <label class="col-md-2 col-form-label text-md-right">@translate(Password)</label>
                                        <div class="col-md-6">
