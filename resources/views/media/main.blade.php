        ...
        <div class="card shadow p-3 mb-5 bg-white rounded">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-md-3">
                        <a href="javascript:void()" onclick="forModal('{{ route('media.create') }}', '@translate(Upload media)')" class="btn btn-primary ml-2">Upload Media <i class="fa fa-cloud-upload ml-2" aria-hidden="true"></i></a>
                    </div>
                    ...
                    <div class="row media_row">
                        @forelse ($medias as $media)
                            ...
                            <div class="col-md-3 col-sm-6 col-xl-3 shadow rounded mb-3 myMedia">
                                ...
                                <a href="#!" onclick="forModal('{{ route('media.edit',$media->id) }}', '@translate(Edit Media)')">
                                    <div class="card m-2">
                                        @if ($media->alt == 'image')
