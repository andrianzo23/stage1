                            ...
                            <div class="logo-right-button">
                                <ul class="d-flex align-items-center">
                                    <li><a href="{{ route('course.single',$s_course->slug) }}"
                                           class="theme-btn theme-btn-light"><i class="la la-star mr-1"></i>@translate(Go
                                            to course details)</a></li>
                                </ul>
                    ...
                    <div class="lecture-video-detail">
                        ...
                        <div class="lecture-video-detail-body">
                            <div class="tab-content">
                                    ...
                                    <div class="lecture-overview-wrap">
                                        <div class="lecture-overview-item">
                                            <div class="lecture-heading">
                                                ...
                                                <p>
                                                    {!! \Mews\Purifier\Facades\Purifier::clean($s_course->short_description) !!}
                                            ...
                                            <div class="lecture-overview-stats-wrap d-flex">
                                                ...
                                                <div
                                                    ...
                                                    <div class="lecture-description show-more-content">
                                                        <p>
                                                            {!! \Mews\Purifier\Facades\Purifier::clean($s_course->big_description) !!}
                                            ...
                                            <div class="lecture-overview-stats-wrap d-flex ">
                                                ...
                                                <div
                                                    ...
                                                    <div class="lecture-owner-decription pt-4">
                                                        {!! \Mews\Purifier\Facades\Purifier::clean($s_course->relationBetweenInstructorUser->relationBetweenInstructor->about) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end lecture-overview-item -->
                                ...
                                {{--CONTENT DETAILS--}}
                                <div role="tabpanel" class="tab-pane fade active show" id="content-details">
                                    <div class="lecture-overview-wrap">
                                        <div class="lecture-overview-item">
                                            <div class="lecture-heading">
                                    ...
                                    <div class="col-lg-6 column-lmd-half column-td-full">
                                        <ul class="list-items">
                                            @foreach(\App\Page::where('active',1)->get() as $item)
                                                <li>
                                                    <a href="{{route('pages',$item->id)}}">{{\Illuminate\Support\Str::ucfirst($item->title)}}</a></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                </div><!-- end row -->
                                                        ...
                                                        @forelse ($item->contents as $content)
                                                            <li class="course-item-link active-resource">
                                                                <div class="course-item-content-wrap">
                                                                    <div class="custom-checkbox">
                                                                        <div class="custom-checkbox">
                                                                            <input type="checkbox" data-url="{{route('seen.remove', $content->id)}}"   id="chb-{{$content->id}}">
                                                                            <label for="chb-{{$content->id}}"></label>
                                                                        </div>
                                                                    </div>


                                                                    <div class="course-item-content" onclick="contentData('{{$content->id}}')">
                                                                        <input type="hidden"
                                                                               id="contentVideoUrl-{{$content->id}}"
                                                                               value="{{route('class.content',$content->id)}}">
                                                                        <h4 class="widget-title font-size-15 font-weight-medium">
