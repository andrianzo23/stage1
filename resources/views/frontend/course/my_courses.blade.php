                                                                    ...
                                                                    <div class="skillbar-box mt-1">
                                                                        <div class="skillbar">
                                                                            <div class="skillbar-bar skillbar-bar-1"
                                                                                 style="width: {{\App\Http\Controllers\Traits\StudentTraits::seenCourse($item->id,$item->enrollCourse->id) }}%;"></div>
                                                                        </div> <!-- End Skill Bar -->
                                                                    </div>
                                                                    <div
                                                                        class="skill-bar-percent">{{\App\Http\Controllers\Traits\StudentTraits::seenCourse($item->id,$item->enrollCourse->id)}}
                                                                        %
                                                                    </div>
                                                                </div>
